...
describe('CloudWatch', () => {
  ...
  describe('.buildCanaryAlarm', () => {
    ...
    it('applies errors preset defaults', () => {
      ...
      expect(alarm.Properties.Period).to.equal(300)
      expect(alarm.Properties.EvaluationPeriods).to.equal(2)
      ...
      expect(alarm.Properties.TreatMissingData).to.equal('missing')
    })
